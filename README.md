...
|---|---|---|---|
| pfSense Network Firewall | Firewall Administration, Network Security, Network Segmentation, Traffic Analysis, Packet Capture, Threat Detection, Firewall Rule Management | pfSense CE, Kali Linux, Ubuntu Desktop, Wireshark, hping3, VirtualBox | [pfSense Net FW](https://github.com/McCloud4871/SIEM) |
