...
|---|---|---|---|
| Cyber Asset Management and CMDB Implementation | Cyber Asset Management, Configuration Management Database (CMDB), IT Asset Inventory, Asset Lifecycle Management, Asset Classification, Governance, Process Improvement, Compliance | Microsoft Excel, Snipe-IT, Qualys Cyber Security Asset Management (CSAM) | [Asset CMDB](#) |
